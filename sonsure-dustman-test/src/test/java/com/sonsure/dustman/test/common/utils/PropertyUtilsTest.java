...
import com.sonsure.dustman.common.utils.PropertyUtils;
...
public class PropertyUtilsTest {
    ...
    public void testGetProperties_PropertiesFile() {
        Map<String, String> props = PropertyUtils.getProperties("utils/init.properties");
    ...
    public void testGetProperties_PropertiesFileWithClassLoader() {
        ...
        Map<String, String> props = PropertyUtils.getProperties("utils/init.properties", classLoader);
        Assertions.assertNotNull(props);
        Assertions.assertFalse(props.isEmpty());
    ...
    public void testGetProperties_PropertiesCache() {
        // 第一次加载
        Map<String, String> props1 = PropertyUtils.getProperties("utils/init.properties");
        // 第二次加载应该使用缓存
        Map<String, String> props2 = PropertyUtils.getProperties("utils/init.properties");
        // 应该是同一个 Map 对象（缓存）
    ...
    public void testGetProperty_WithExistingKey() {
        String value = PropertyUtils.getProperty("utils/init.properties", "driverClassName");
    ...
    public void testGetProperty_WithExistingKeyAndClassLoader() {
        ClassLoader classLoader = Thread.currentThread().getContextClassLoader();
        String value = PropertyUtils.getProperty("utils/init.properties", "jdbcUrl", classLoader);
        Assertions.assertNotNull(value);
    ...
    public void testGetProperty_WithNonExistentKey() {
        String value = PropertyUtils.getProperty("utils/init.properties", "nonExistentKey");
        Assertions.assertNull(value);
    }

    @Test
    public void testGetProperty_WithDefaultValue() {
        String value = PropertyUtils.getProperty("utils/init.properties", "nonExistentKey", "defaultValue");
        Assertions.assertNotNull(value);
    ...
    public void testGetProperty_WithDefaultValueAndClassLoader() {
        ClassLoader classLoader = Thread.currentThread().getContextClassLoader();
        String value = PropertyUtils.getProperty("utils/init.properties", "nonExistentKey", "defaultValue", classLoader);
        Assertions.assertNotNull(value);
        Assertions.assertEquals("defaultValue", value);
    }
    ...
    public void testGetProperty_ExistingKeyWithDefaultValue() {
        // 当 key 存在时，不应该返回默认值
        String value = PropertyUtils.getProperty("utils/init.properties", "driverClassName", "defaultValue");
        Assertions.assertNotNull(value);
        Assertions.assertEquals("org.h2.Driver", value);
    ...
    public void testGetProperty_EmptyValueWithDefaultValue() {
        ...
        String value = PropertyUtils.getProperty("utils/init.properties", "password", "defaultPassword");
    ...
    public void testGetProperty_NullKey() {
        String value = PropertyUtils.getProperty("utils/init.properties", null);
        Assertions.assertNull(value);
    }

    @Test
    public void testGetProperty_NullKeyWithDefault() {
        String value = PropertyUtils.getProperty("utils/init.properties", null, "default");
        Assertions.assertNotNull(value);
        Assertions.assertEquals("default", value);
    }
    ...
    public void testGetProperty_EmptyKey() {
        String value = PropertyUtils.getProperty("utils/init.properties", "");
        Assertions.assertNull(value);
    }

    @Test
    public void testGetProperty_EmptyKeyWithDefault() {
        String value = PropertyUtils.getProperty("utils/init.properties", "", "default");
        Assertions.assertNotNull(value);
        Assertions.assertEquals("default", value);
    }
    ...
    public void testGetProperties_DifferentClassLoader() {
        ...
        Map<String, String> props1 = PropertyUtils.getProperties("utils/init.properties", classLoader1);
        Map<String, String> props2 = PropertyUtils.getProperties("utils/init.properties", classLoader2);
    ...
    public void testGetProperty_DifferentClassLoader() {
        ...
        String value1 = PropertyUtils.getProperty("utils/init.properties", "driverClassName", classLoader1);
        String value2 = PropertyUtils.getProperty("utils/init.properties", "driverClassName", classLoader2);
    ...
    public void testGetProperty_CacheConsistency() {
        String value1 = PropertyUtils.getProperty("utils/init.properties", "driverClassName");
        String value2 = PropertyUtils.getProperty("utils/init.properties", "driverClassName");
    ...
    public void testGetProperty_RealWorldScenario() {
        ...
        String driverClass = PropertyUtils.getProperty("utils/init.properties", "driverClassName");
        String jdbcUrl = PropertyUtils.getProperty("utils/init.properties", "jdbcUrl");
        String username = PropertyUtils.getProperty("utils/init.properties", "jdbcUsername");
        String password = PropertyUtils.getProperty("utils/init.properties", "password", "");
    ...
    public void testGetProperty_MultipleCalls() {
        ...
        String value1 = PropertyUtils.getProperty("utils/init.properties", "driverClassName");
        String value2 = PropertyUtils.getProperty("utils/init.properties", "driverClassName");
        String value3 = PropertyUtils.getProperty("utils/init.properties", "driverClassName");
