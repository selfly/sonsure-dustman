...
import com.sonsure.dustman.common.enums.DynamicEnum;
import com.sonsure.dustman.common.enums.DynamicEnumItem;
import com.sonsure.dustman.common.enums.EnumHelper;
...
public class EnumTest {
    ...
    public void testGetEnumItemRequired() {
        ...
        Assertions.assertEquals("枚举不存在,class:com.sonsure.dustman.test.enums.MenuStatusEnum,code:8", sonsureCommonsException.getMessage());
        ...
        Assertions.assertEquals("枚举不存在,class:com.sonsure.dustman.test.enums.MenuTypeEnum,code:8", sonsureCommonsException2.getMessage());
    }
    ...
    public void removeDynamicEnumItem() {
        ...
        Assertions.assertEquals("自带枚举值不允许删除 class com.sonsure.dustman.test.enums.MenuStatusEnum code:2", sonsureCommonsException.getMessage());
