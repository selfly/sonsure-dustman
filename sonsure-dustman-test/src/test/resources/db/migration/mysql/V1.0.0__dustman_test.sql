CREATE TABLE `sd_user_info` (
  ...
  `user_type` varchar(64) NULL COMMENT 'userType',
  `status` varchar(64) NULL COMMENT 'status',
  `gender` varchar(64) NULL COMMENT 'gender',
  `real_name` varchar(64) NULL COMMENT 'realName',
  `email` varchar(64) NULL COMMENT 'email',
  `mobile` varchar(64) NULL COMMENT 'mobile',
  `avatar` varchar(64) NULL COMMENT 'avatar',
  `description` varchar(64) NULL COMMENT 'description',
