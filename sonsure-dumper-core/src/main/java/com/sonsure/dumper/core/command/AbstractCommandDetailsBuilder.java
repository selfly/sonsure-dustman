...
//
//    @Override
//    public CommandDetails build(JdbcEngineConfig jdbcEngineConfig, ExecutionType executionType) {
...
//        executableCmd.setToggleCase(jdbcEngineConfig.getCommandCase());
...
//     * @param toggleCase the command case
//     * @return string
//     */
